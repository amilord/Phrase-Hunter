...
class Game {
    ...
    createPhrases() {
        this.phrases[0] = new Phrase('Life is like a box of chocolates');
    ...
    checkForWin() {
        const win = document.getElementsByClassName("hide").length == 0;
        return win;
    }

    removeLife() {
        const lifeImage = document.getElementsByClassName("tries")[this.missed].getElementsByTagName("img")[0];
